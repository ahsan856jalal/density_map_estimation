...
def main(args):
    ...
    save_path = "/content/drive/MyDrive/MARUNet/Models/"+save_name+".pth"
    logger = get_logger('/content/drive/MyDrive/MARUNet/Models/'+save_name+'.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss', default='mse+ssim', choices=['mse','mse+lc','ssim','mse+ssim','lsa+lsc','lsa','dms-ssim', 'ms-ssim','bayes+', '2avg-ms-ssim', '3avg-ms-ssim', '4avg-ms-ssim', '5avg-ms-ssim', 'mse+mae', 'mse+count'])
    ...
    parser.add_argument('--use_bg', action='store_true', help='Include background in the loss calculation')
    parser.add_argument('--warm_up', action='store_true', help='Enable warm-up phase')
