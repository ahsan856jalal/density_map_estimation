...
class FeatureVisualization():
    def __init__(self,img_path,selected_layer):
        ...
        self.pretrained_model = MARNet(load_model="/content/drive/MyDrive/MARUNet/Models/MARNet_sha.pth", downsample=1, objective='dmp+amp', save_feature=True)
    ...
    def save_feature_to_img(self):
        save_dir='/content/drive/MyDrive/MARUNet/figs/visual_feature'
...
def main(args):
  ...
  if args.img_path != '':
    myClass=FeatureVisualization(args.img_path,5)
